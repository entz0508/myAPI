        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/index.html" class="site_title"><i class="fa fa-paw"></i> <span>ADB Admin</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="/"><i class="fa fa-home"></i> Home <!--<span class="fa fa-chevron-down"></span>--></a>
                    ...
                    <li>
                        <a><i class="fa fa-desktop"></i> 회원 관리 <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="/account/user.html">회원 조회</a></li>
                ...
                <li>
                    <a><i class="fa fa-edit"></i> 채널 관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="/news/banner.html">Top Banner 관리</a></li>
                        <li><a href="/news/banner_bottom.html">Bottom Banner 관리</a></li>
                        <li><a href="/news/todays.html">Todays 관리</a></li>
                    </ul>
                </li>
