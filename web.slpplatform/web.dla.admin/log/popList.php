				...
				*/
                ...
                <section class="panel">
                    <header class="panel-heading">
                                    EBSLang Log List &nbsp;&nbsp;&nbsp;[ <?=$page?>/ <?=$allPage?> ] <a href="javascript:GetEBSReport('<?=$stepAttendID ?>','<?=$encUserID ?>','<?=$buyIP ?>');">[리포트 보기]</a>
                    </header>
                    <table class="table table-striped table-advance table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=$row['LESSON_TITLE']?>
								<a href="javascript:Getplay('<?=$row['STEP_ATTEND_ID']?>','<?=$row['LESSON_TMPL_ID']?>','<?=$row['EBS_PDT_ID']?>','<?=$row['enc_user_id']?>','<?=$row['BUY_IP']?>');">[학습하기]</a>
								</td>
                            </tr>
                            <?
                        }
