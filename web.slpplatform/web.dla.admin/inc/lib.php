<? 
function appName($app_id){
	switch ($app_id) {
		case "1000000001" : $app_Name="Dora 영어-도라의 영어모험"; break;
		case "1000000003" : $app_Name="Dora lv1-도라영유아편"; break;
		case "1000000004" : $app_Name="Dora lv2-레벨 1"; break;
        case "1000000005" : $app_Name="Dora lv3-레벨 2"; break;
        case "1000000007" : $app_Name="Dora EBS"; break;
        default : $app_Name = $app_id."(미등록)"; break;
	}
    return $app_Name;
}


function ebsStatus($ATTEND_STAT_CD){
	switch ($ATTEND_STAT_CD) {
		case "L15SH1" : $ATTEND_STAT="대기중"; break;
		case "L15SH2" : $ATTEND_STAT="학습중"; break;
		case "L15SH3" : $ATTEND_STAT="복습중"; break;
		case "L15SH4" : $ATTEND_STAT="수강완료"; break;
		case "L15SH5" : $ATTEND_STAT="수강대기취소"; break;
		case "L15SH6" : $ATTEND_STAT="수강취소"; break;
		case "L15SH7" : $ATTEND_STAT="대기취소중"; break;
		case "L15SH8" : $ATTEND_STAT="수강취소중"; break;
        default : $ATTEND_STAT = $ATTEND_STAT_CD."(미등록)"; break;
	}
    return $ATTEND_STAT;
}
