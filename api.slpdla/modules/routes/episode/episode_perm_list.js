...
exports.add_routes = function(app) {
	app.post("/sdla/episode/permlist", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res) {
		...
		try {
			...
			MYSQL_SLP_DLA_CONN.procGetEpisodePermList(requestParams, function(err, results) {
				if (err) {
