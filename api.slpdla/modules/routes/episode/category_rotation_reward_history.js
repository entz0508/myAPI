...
exports.add_routes = function(app) {
	app.post("/sdla/episode/categoryRotationRewardHistory", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITH_PROFILE, function(req, res) {
		...
		try {
			...
			MYSQL_SLP_DLA_CONN.procCategoryRotationRewardHistory(requestParams, function(err, results) {
				if (err) {
