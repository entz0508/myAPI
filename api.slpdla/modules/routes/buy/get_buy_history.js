...
exports.add_routes = function(app) {
	app.post("/sdla/buy/buyHistory", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res) {
		...
		try {
            ...
            if (!COMMON_UTIL.isValidAccessToken(requestParams.accessToken)) {
                ...
                var tmpAccesstokenStr = "";
                tmpAccesstokenStr = requestParams.accessToken;
                console.log(tmpAccesstokenStr);
			...
			MYSQL_SLP_DLA_CONN.procGetBuyHistory(requestParams, function(err, results) {
				if (err) {
