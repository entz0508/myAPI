...
function add_routes(app) {
    ...
    app.post("/skw/push/token/reg", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res){
        ...
        try {
            ...
            if(!COMMON_UTIL.isValidDeviceToken(requestParams.deviceToken) ) {
                PRINT_LOG.error(__filename, API_PATH, " error, params, deviceToken:" + requestParams.deviceToken);
