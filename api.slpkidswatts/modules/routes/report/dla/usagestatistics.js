...
function add_routes(app) {
    ...
    app.post("/skw/report/usagestatistics", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res){
        ...
        try {
            ...
            var responseObj = {};
            responseObj.update_ts = 0;
            responseObj.d_ep_p_cnt_average = 0;
            responseObj.d_ep_p_time_average = 0;
            ...
            responseObj.ep_preferred_score = [];
            {
                ...
                obj.ep_id = "";
                obj.score = "0";
                responseObj.ep_preferred_score.push(obj);
            }
