...
function add_routes(app) {
    ...
    var checkParams = function(requestParams) {
        ...
        if( !COMMON_UTIL.isValidAppID(requestParams.appID) || !COMMON_UTIL.isValidClientUID(requestParams.clientUID) ||
            ...
            !COMMON_UTIL.isValidAccessToken(requestParams.accessToken) || COMMON_UTIL.isValidActionType(requestParams.actionType) ||
    ...
    app.post("/sdla/action/addlog", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res){
