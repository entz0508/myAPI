...
exports.add_routes = function(app) {
    ...
    app.post("/sen/action/nde/log", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITH_PROFILE, function(req, res) {
        ...
        try {
            ...
            requestParams.unitID = COMMON_UTIL.trim(req.body.unit_id);      //NDE
            requestParams.lessonID = COMMON_UTIL.trim(req.body.lesson_id);  //NDE
            requestParams.levelID = COMMON_UTIL.trim(req.body.level_id);    //NDE
            requestParams.chapter = 0;
