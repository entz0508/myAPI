...
function add_routes(app) {
    ...
    app.post("/sen/etc/productPerm", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res){
                ...
                if(err) {
                    ...
                    if( (0 < results[0].length) ) {                      
                        ...
                        for(var i=0; i<len; i++) {
							...
							obj.period_type		= row.PERIOD_TYPE; 
                            
                            if( requestParams.os == 'android' && obj.product_id == 'lanpack_period_en' ) {
                                
                            } else if ( requestParams.os == 'ios' && obj.product_id == 'lanpack_en' ) {
