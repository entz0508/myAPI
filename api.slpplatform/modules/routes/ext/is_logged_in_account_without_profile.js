...
exports.add_routes = function(app) {
	function checkParams(API_PATH, appID, clientUID, accountID, accessToken) {
		var errParam;
	...
	app.post("/slp/user/account/isloggedin/withoutprofile", ROUTE_MIDDLEWARE.AUTH_APP_LOGIN_USER_ALLOW_APP, function(req, res) {
