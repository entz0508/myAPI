...
exports.add_routes = function (app) {
    ...
    app.post("/nde/open/statususer", ROUTE_MIDDLEWARE.NO_AUTH_APP, function(req, res) {
        ...
        try {
            ...
            if (xa.length > 0) {
                ...
                //
                // MYSQL_SLP_NDE.procGetOpenUserTokenVal(requestParams, function (err, results) {
                //     if (err) {
                //         PRINT_LOG.setErrorLog("Failed, MYSQL_SLP_NDE.procGetOpenUserTokenVal", err);
