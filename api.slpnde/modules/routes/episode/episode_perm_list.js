...
exports.add_routes = function(app) {
    app.post("/nde/episode/permlist", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res) {
        ...
        try {
            ...
            if (requestParams.seqID == null) {
                requestParams.seqID = 0;
            }
            ...
            MYSQL_SLP_NDE.procGetEpisodePermList(requestParams, function(err, results) {
                ...
                if ((0 < results[0].length)) {
                    ...
                    lastSEQ.EXPIRED_DATE = "none";
                    lastSEQ.BUY_PATH = "none";
                    lastSEQ.ATTEND_STAT_CD = "none";
                    lastSEQ.LESSON_LIST = [];
                    var lastLesson = {};
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        if(lastSEQ.EXPIRED == 'N'){
                            ...
                            if (lastSEQ.SEQ_ID === row.SEQ_ID) {
                                ...
                                lastSEQ.BUY_PATH = row.BUY_PATH;
                                lastSEQ.ATTEND_STAT_CD = row.ATTEND_STAT_CD;
                                lastSEQ.LESSON_LIST = [];
                ...
                PACKET.sendSuccess(req, res, {SEQBuyList: SEQBuyList});
            });
        } catch (catchErr) {
