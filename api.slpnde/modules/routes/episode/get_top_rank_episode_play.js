...
exports.add_routes = function(app) {
	app.post("/nde/episode/getTopRankEpisodePlay", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITHOUT_PROFILE, function(req, res) {
		...
		try {
            ...
            MYSQL_SLP_NDE.procGetTopRankEpisodePlay(requestParams, function(err, results) {
				if (err) {
