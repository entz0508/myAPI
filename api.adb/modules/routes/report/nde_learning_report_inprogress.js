...
exports.add_routes = function(app) {
    app.post("/nde/report/learning/inprogress", ROUTE_MIDDLEWARE.LOGGED_IN_ACCOUNT_WITH_PROFILE, function(req, res){
        ...
        try {
            ...
            MYSQL_SLP_KW_ACTION_LOG_CONN.procGetNDEReportOverViewInprogress(requestParams, function(err, results) {
                // var completeList= [];

                if (err) {
                    PRINT_LOG.error(__filename, API_PATH, " MYSQL_SLP_KW_ACTION_LOG_CONN.procGetNDEReportOverViewInprogress, fail db, error");
