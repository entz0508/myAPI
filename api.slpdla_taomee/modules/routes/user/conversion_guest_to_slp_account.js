...
function add_routes(app) {
    ...
    var undoConversion = function(appID, clientUID, slpAccountID, slpAccountAccessToken, userID) {
        PRINT_LOG.error(__filename, "", " undoConversion, appID:" + appID + ", clientUID:" + clientUID +
                                        ", slpAccountID:" + slpAccountID + ", slpAccountAccessToken:" + slpAccountAccessToken + ", userID:" +userID);
