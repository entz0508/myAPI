...
function add_routes(app) {
    ...
    app.post("/slp.playlog.add", ROUTE_MIDDLEWARE.LOGGED_IN_USER, function(req, res){
        ...
        try {
            ...
            requestParams.logType = COMMON_UTIL.trim(req.body.log_type);   // ep_start, ep_end, ch_start, ch_end
            ...
            if( !COMMON_UTIL.isValidAppID(requestParams.appID) || !COMMON_UTIL.isValidClientUID(requestParams.clientUID) ||
                ...
                MYSQL_SLP_ACCOUNT_PLAYLOG.procAddPlaylog(requestParams, function (err, results) {
                    if (err) {
